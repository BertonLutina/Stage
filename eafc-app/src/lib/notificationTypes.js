...
export const NOTIFICATION_TYPES = {
  ...
  match_invite: { settingKey: 'match_reminders' },
  league_schedule: { settingKey: 'match_reminders' },
  match_result_requested: { settingKey: 'match_results' },
  match_disputed: { settingKey: 'match_results' },
  match_completed: { settingKey: 'match_results' },
