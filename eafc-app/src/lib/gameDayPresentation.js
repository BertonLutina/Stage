...
export function getKickoffCountdownParts(scheduledDate, now = new Date(), timeZone) {
  if (!scheduledDate) return null;
  const date = scheduledDate instanceof Date ? scheduledDate : parseKickoffDate(scheduledDate, timeZone);
