 ...
 */
import nlSettings from "./packs/nl.settingsPage.json";
import esSettings from "./packs/es.settingsPage.json";
import deSettings from "./packs/de.settingsPage.json";
import itSettings from "./packs/it.settingsPage.json";
import ptSettings from "./packs/pt.settingsPage.json";
import zhSettings from "./packs/zh.settingsPage.json";
import jaSettings from "./packs/ja.settingsPage.json";
import koSettings from "./packs/ko.settingsPage.json";
import ruSettings from "./packs/ru.settingsPage.json";
import plSettings from "./packs/pl.settingsPage.json";
import trSettings from "./packs/tr.settingsPage.json";
import arSettings from "./packs/ar.settingsPage.json";
