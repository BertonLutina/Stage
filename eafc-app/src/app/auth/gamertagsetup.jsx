  ...
  return (
    <SafeAreaView className="flex-1 px-6 justify-center">
      <View className="border border-lineInner/30 rounded-3xl px-6 py-7">
        <STText color="#FFFFFF" className="text-2xl font-bold mb-2">Gamertag Setup</STText>
        <STText color="#FFFFFF" className="mb-4 opacity-80">Choose your identity name for STAGE.</STText>
